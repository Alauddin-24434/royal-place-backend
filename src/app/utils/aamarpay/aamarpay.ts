...
export const initiatePayment = async ({
  ...
  const payload = {
    ...
    success_url: `http://localhost:5000/api/verify-payment?transactionId=${transactionId}`,
    fail_url: `http://localhost:5000/api/payment/fail?transactionId=${transactionId}`,
    cancel_url:`http://localhost:5000/api/payment/cancel?transactionId=${transactionId}`,
    cus_name: name,
    cus_email: email,
    cus_phone: phone,
