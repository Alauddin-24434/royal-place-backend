...
router.post("/room", uploadMiddleware_1.default.array("images", 5), room_controller_1.roomController.createRoom);
...
router.patch("/room/:id", room_controller_1.roomController.updateRoom);
router.delete("/room/:id", room_controller_1.roomController.deleteRoom);
